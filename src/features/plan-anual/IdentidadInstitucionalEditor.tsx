    ...
    return (
        <div className="max-w-[1600px] mx-auto space-y-12 animate-fade-in pb-48 px-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <Card variant="strong">
                    <CardHeader>
                        <CardTitle>2.1 Información Institucional</CardTitle>
                    </CardHeader>
                    <CardContent className="space-y-4">
                        ...
                        <div className="p-4 bg-primary-teal/5 border border-primary-teal/20 rounded-2xl">
                            <p className="text-xs text-primary-teal font-medium">
                                * Estos datos son heredados del onboarding. Puedes editarlos en "Mi Perfil".
                            </p>
                        </div>
                    </CardContent>
                </Card>

                <Card variant="glass" className="lg:col-span-2 overflow-hidden relative">
                    ...
                    <CardHeader>
                        <CardTitle className="flex items-center gap-2">
                            ...
                            2.4 Lema del Aula (Propósito Motivacional)
                        </CardTitle>
                    ...
                    <CardContent>
                        <div className="relative">
                            ...
                            <div className="flex justify-center mt-4">
                                <span className="px-3 py-1 bg-brand-magenta/10 text-brand-magenta rounded-full text-[9px] font-black uppercase tracking-tighter">
                                    Visión Inspiradora
                                </span>
                            </div>
                        </div>
                ...
                <Card variant="glass" className="lg:col-span-2">
                    <CardHeader>
                        <CardTitle className="flex items-center gap-2">
                            ...
                            2.3 ADN Pedagógico (Metodologías Activas)
                        </CardTitle>
                        <p className="text-[10px] text-gray-500 uppercase font-bold tracking-widest mt-1">
                ...
                <Card variant="strong">
                    <CardHeader>
                        <CardTitle>2.2 Caracterización del Área</CardTitle>
                    </CardHeader>
                    <CardContent className="space-y-6">
                        <div className="space-y-4">
                            ...
                            <textarea
                                className="w-full h-48 bg-surface-card border border-white/5 rounded-2xl p-4 text-xs text-gray-400 focus:outline-none focus:ring-1 focus:ring-primary-teal/30 leading-relaxed custom-scrollbar"
                        ...
                        <div className="flex items-center gap-2 p-3 bg-white/5 rounded-xl border border-white/5">
                            <span className="material-icons-round text-primary-teal text-sm">info</span>
                            <p className="text-[10px] text-gray-500">
                                La IA usará el perfil del área según el CNEB y el diagnóstico contextual para redactar esta sección.
                            </p>
                        </div>
                    </CardContent>
                </Card>
